...
const (
	...
	TodoService_GetTodosByDeadline_FullMethodName = "/todo.TodoService/GetTodosByDeadline"
)
...
type TodoServiceClient interface {
	...
	// Getting tasks by deadline
	GetTodosByDeadline(ctx context.Context, in *GetTodosByDeadlineRequest, opts ...grpc.CallOption) (*GetTodosByDeadlineResponse, error)
}
...
func (c *todoServiceClient) GetTodosByDeadline(ctx context.Context, in *GetTodosByDeadlineRequest, opts ...grpc.CallOption) (*GetTodosByDeadlineResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTodosByDeadlineResponse)
	err := c.cc.Invoke(ctx, TodoService_GetTodosByDeadline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TodoServiceServer interface {
	...
	// Getting tasks by deadline
	GetTodosByDeadline(context.Context, *GetTodosByDeadlineRequest) (*GetTodosByDeadlineResponse, error)
...
func (UnimplementedTodoServiceServer) GetTodosByDeadline(context.Context, *GetTodosByDeadlineRequest) (*GetTodosByDeadlineResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTodosByDeadline not implemented")
}
...
func _TodoService_GetTodosByDeadline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTodosByDeadlineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TodoServiceServer).GetTodosByDeadline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TodoService_GetTodosByDeadline_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).GetTodosByDeadline(ctx, req.(*GetTodosByDeadlineRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TodoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTodosByDeadline",
			Handler:    _TodoService_GetTodosByDeadline_Handler,
		},
	},
